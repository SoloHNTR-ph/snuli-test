            ...
            if(user) {
                ...
                if (userDoc.exists()) {
                    ...
                    if (userData.role === 'webmaster') {
                        console.log('User is webmaster, creating session');
                        ...
                        console.log('User is not webmaster:', userData.role);
                        await auth.signOut();
                        alert('Access denied. Only webmasters can access the dashboard.');
                    }
                } else {
