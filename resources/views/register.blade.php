...
<body class="bg-gray-50 text-gray-800 font-inter">
    <!-- Navigation -->
    <nav class="fixed top-0 left-0 w-full bg-white/80 backdrop-blur-md z-50 shadow-sm">    <!-- Navigation -->
    <nav class="fixed top-0 left-0 w-full bg-white/80 backdrop-blur-md z-50 shadow-sm">
        <div class="container mx-auto px-6 py-4">
            <div class="flex items-center justify-between">
                <a href="{{ route('home') }}" class="text-2xl font-bold text-[#8daef4] hover:text-[#6b8cd5] transition-colors duration-300">
                    Brand
                </a>
                <a href="{{ route('home') }}" class="text-gray-600 hover:text-[#8daef4] transition-colors duration-300">
                    Back to Home
                </a>
            </div>
        </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="text-center">
                                    <p class="text-sm text-gray-600">Already have an account? 
                                        <a href="{{ route('login') }}" class="text-[#8daef4] hover:text-[#6b8cd5] font-medium">
                                            Sign in
                                        </a>
                                    </p>
                                </div>
